...
var FakeTransactionsRepository_1 = __importDefault(require("../repositories/fakes/FakeTransactionsRepository"));
var CreateTransactionService_1 = __importDefault(require("./CreateTransactionService"));
var fakeTransactionsRepository;
var fakeNotificationsRepository;
var createAppointment;
describe('CreateTransaction', function () {
    beforeEach(function () {
        fakeTransactionsRepository = new FakeTransactionsRepository_1.default();
        fakeNotificationsRepository = new FakeNotificationsRepository_1.default();
        createAppointment = new CreateTransactionService_1.default(fakeTransactionsRepository, fakeNotificationsRepository);
    });
