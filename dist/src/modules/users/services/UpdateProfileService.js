                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (password && !old_password) {
                            throw new AppError_1.default('The old password is required to update your password.');
                        }
                        if (!(password && old_password)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.hashProvider.compareHash(user.password, old_password)];
                    case 3:
                        checkOldPassword = _c.sent();
                        if (!checkOldPassword) {
                            throw new AppError_1.default('Incorret password.');
                        }
                        _b = user;
