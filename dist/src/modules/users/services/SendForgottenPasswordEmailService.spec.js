...
var SendForgottenPasswordEmailService_1 = __importDefault(require("./SendForgottenPasswordEmailService"));
var fakeUsersRepository;
var fakeMailProvider;
var fakeUserTokensRepository;
var sendForgottenPasswordEmail;
describe('SendForgottenPasswordEmail', function () {
    beforeEach(function () {
        ...
        sendForgottenPasswordEmail = new SendForgottenPasswordEmailService_1.default(fakeUsersRepository, fakeMailProvider, fakeUserTokensRepository);
    });
    it('should be able to recovery its password using the email', function () { return __awaiter(void 0, void 0, void 0, function () {
        var sendMail;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgottenPasswordEmail.execute({
                            email: 'johndoe@example.com',
                        })];
                case 2:
                    _a.sent();
    ...
    it('should not be able to recover a non existing user password', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgottenPasswordEmail.execute({
    ...
    it('should generate a forgotten password token', function () { return __awaiter(void 0, void 0, void 0, function () {
