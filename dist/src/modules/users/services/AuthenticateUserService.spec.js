...
var fakerHashProvider;
var createUser;
var authenticateUser;
describe('AuthenticateUser', function () {
    beforeEach(function () {
        fakeUsersRepository = new FakeUsersRepository_1.default();
        fakerHashProvider = new FakeHashProvider_1.default();
        createUser = new CreateUserService_1.default(fakeUsersRepository, fakerHashProvider);
        authenticateUser = new AuthenticateUserService_1.default(fakeUsersRepository, fakerHashProvider);
    });
